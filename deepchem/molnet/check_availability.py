CheckFeaturizer = {
    ...
    ('nci_logp', 'logreg'): ['ECFP', 1024],
    ('nci_logp', 'tf_regression'): ['ECFP', 1024],
    ('nci_logp', 'rf_regression'): ['ECFP', 1024],
    ('nci_logp', 'krr'): ['ECFP', 1024],
    ('nci_logp', 'xgb_regression'): ['ECFP', 1024],
    ('nci_logp', 'graphconvreg'): ['GraphConv', 75],
    ('nci_logp', 'weave_regression'): ['Weave', 75],
...
CheckSplit = {
    ...
    'nci_logp': ['index', 'random', 'scaffold'],
